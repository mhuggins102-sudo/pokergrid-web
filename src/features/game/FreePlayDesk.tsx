...
import styles from './FreePlayDesk.module.css';

/*
 * The ≥1024px Free Play entry, per design-refs/desktop/Free Play.dc.html:
 * four difficulty cards (select-on-click, Medium preselected), each
 * carrying the target, a blurb, and the five rule axes from the real
 * rules tables; below, the Starting bar with the seeded-run toggle and
 * the Start button. Below the breakpoint DifficultyPicker renders the
