...
import styles from './AchievementsDesk.module.css';

/*
 * The ≥1024px trophy case, per design-refs/desktop/Achievements.dc.html:
 * header with the earned tally + progress ring, then one section per
 * tier — heading, note, per-tier progress — over a three-column card
 * grid. Earned cards get the warn-toned ★ medal and border; locked ones
 * dim with an ○. Earned state comes from the real stats store. Below
 * the breakpoint AchievementsPage renders the phone list unchanged.
 */
...
export function AchievementsDesk() {
