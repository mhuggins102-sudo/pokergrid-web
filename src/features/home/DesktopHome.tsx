...
/*
 * The ≥1024px landing page, per design-refs/desktop/Home.dc.html:
 * a hero CTA for today's daily (recipe chips + streak), the
 * three-mode card row, and the newcomer footer strip. Every number
 * binds to the real recipe / challenge catalog / streak helper.
 */
