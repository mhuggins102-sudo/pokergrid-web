...
import styles from './StatsDesk.module.css';

/*
 * The ≥1024px stats dashboard, per design-refs/desktop/Stats.dc.html:
 ...
 * bind to the same buildModeStats roll-up the phone page uses. Below
 * the breakpoint StatsPage renders the phone dashboard unchanged.
 */
