...
import styles from './RulesDesk.module.css';

/*
 * The ≥1024px rules page, per design-refs/desktop/Rules.dc.html:
 * numbered how-to-play steps + the −25 / 10-lines fact cards beside the
 * hand-values table, then the full bonus-card reference inline —
 * filterable by the three payout tones (in-game gold, end-game purple,
 * one-time green). Hand values and cards bind to the real scoring
 * tables / bonus pools. Below the breakpoint RulesPage renders the
 * phone article unchanged (with its separate /rules/cards reference).
 */
