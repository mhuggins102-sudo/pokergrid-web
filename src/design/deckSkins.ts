...
const IMPRESSION_SUIT: Record<SuitKey, string> = { h: '#a2707e', d: '#a2707e', c: '#6b5a70', s: '#6b5a70' };
const IMPRESSION_HALO: Record<SuitKey, string> = { h: 'rgba(162,112,126,.4)', d: 'rgba(162,112,126,.4)', c: 'rgba(107,90,112,.4)', s: 'rgba(107,90,112,.4)' };
...
const DESKTOP: Record<string, Builder> = {
  ...
  AR3: ({ G, R }) => ({ extra: 'border:1px solid var(--hairline);background:#efe9dc', layers: [L('position:absolute;right:-12cqw;top:-12cqh;width:48cqmin;height:48cqmin;border-radius:50%;background:#d23a2e'), L('position:absolute;left:-8cqw;bottom:-8cqh;width:58cqmin;height:58cqmin;background:#e8b90f;clip-path:polygon(0 100%,0 30%,76% 100%)'), L('position:absolute;right:-18cqw;top:40cqh;width:46cqmin;height:46cqmin;border:4.5cqmin solid #1f4bb8;border-radius:50%'), L('position:absolute;left:2cqw;top:70cqh;width:96cqw;height:1.5cqmin;background:#1c1a17;transform:rotate(-16deg)'), L('position:absolute;top:7cqh;left:9cqw;font:700 34cqh var(--font-body);line-height:1;letter-spacing:-.03em;color:#1c1a17', R), L('position:absolute;top:8cqh;right:7cqw;font-size:22cqh;line-height:1;color:#fdf6ec', G)] }),
  AR4: ({ G, R, k }) => ({ extra: 'border:1px solid var(--hairline);background:#f2ede3', layers: [L('position:absolute;inset:0;background:radial-gradient(circle at 16% 20%,rgba(169,191,160,.6) 0 7%,transparent 10.5%),radial-gradient(circle at 34% 12%,rgba(217,166,173,.55) 0 6%,transparent 9%),radial-gradient(circle at 78% 16%,rgba(159,180,216,.55) 0 7%,transparent 10.5%),radial-gradient(circle at 90% 34%,rgba(179,163,204,.5) 0 6%,transparent 9%),radial-gradient(circle at 12% 46%,rgba(221,203,154,.55) 0 6.5%,transparent 10%),radial-gradient(circle at 46% 40%,rgba(143,168,134,.5) 0 7%,transparent 10.5%),radial-gradient(circle at 70% 52%,rgba(217,166,173,.5) 0 6%,transparent 9.5%),radial-gradient(circle at 28% 66%,rgba(159,180,216,.5) 0 7%,transparent 10.5%),radial-gradient(circle at 88% 70%,rgba(169,191,160,.55) 0 6.5%,transparent 10%),radial-gradient(circle at 52% 82%,rgba(179,163,204,.5) 0 6%,transparent 9.5%),radial-gradient(circle at 14% 86%,rgba(196,141,151,.45) 0 5.5%,transparent 8.5%),radial-gradient(circle at 72% 90%,rgba(221,203,154,.5) 0 6%,transparent 9.5%)'), L('position:absolute;inset:0;transform:scale(1,.5);transform-origin:50% 60%;background:radial-gradient(circle at 24% 30%,rgba(217,166,173,.4) 0 8%,transparent 12%),radial-gradient(circle at 62% 22%,rgba(169,191,160,.4) 0 9%,transparent 13%),radial-gradient(circle at 84% 48%,rgba(159,180,216,.4) 0 8%,transparent 12%),radial-gradient(circle at 38% 58%,rgba(221,203,154,.35) 0 8%,transparent 12%),radial-gradient(circle at 10% 66%,rgba(179,163,204,.35) 0 7%,transparent 11%),radial-gradient(circle at 70% 78%,rgba(196,141,151,.35) 0 8%,transparent 12%)'), L(`position:absolute;top:6cqh;left:9cqw;font:540 34cqh var(--font-display);line-height:1;color:${IMPRESSION_SUIT[k]};text-shadow:0 0 1cqmin ${IMPRESSION_HALO[k]}`, R), L(`position:absolute;bottom:6cqh;right:9cqw;font-size:24cqh;line-height:1;color:${IMPRESSION_SUIT[k]};text-shadow:0 0 1cqmin ${IMPRESSION_HALO[k]}`, G)] }),
...
const MOBILE: Record<string, Builder> = {
  ...
  AR3: ({ G, R }) => ({ extra: 'border:1px solid var(--hairline);background:#efe9dc', layers: [L('position:absolute;right:-12cqw;top:-12cqh;width:52cqmin;height:52cqmin;border-radius:50%;background:#d23a2e'), L('position:absolute;left:-8cqw;bottom:-8cqh;width:58cqmin;height:58cqmin;background:#e8b90f;clip-path:polygon(0 100%,0 30%,76% 100%)'), L('position:absolute;right:-18cqw;top:44cqh;width:46cqmin;height:46cqmin;border:4.5cqmin solid #1f4bb8;border-radius:50%'), L('position:absolute;left:2cqw;top:74cqh;width:96cqw;height:1.5cqmin;background:#1c1a17;transform:rotate(-16deg)'), L('position:absolute;top:6cqh;left:8cqw;font:700 40cqh var(--font-body);line-height:1;letter-spacing:-.03em;color:#1c1a17', R), L('position:absolute;top:7cqh;right:6cqw;font-size:27cqh;line-height:1;color:#fdf6ec', G)] }),
  AR4: ({ G, R, k }) => ({ extra: 'border:1px solid var(--hairline);background:#f2ede3', layers: [L('position:absolute;inset:0;background:radial-gradient(circle at 16% 20%,rgba(169,191,160,.6) 0 7%,transparent 10.5%),radial-gradient(circle at 78% 16%,rgba(159,180,216,.55) 0 7%,transparent 10.5%),radial-gradient(circle at 12% 46%,rgba(221,203,154,.55) 0 6.5%,transparent 10%),radial-gradient(circle at 46% 40%,rgba(143,168,134,.5) 0 7%,transparent 10.5%),radial-gradient(circle at 70% 52%,rgba(217,166,173,.5) 0 6%,transparent 9.5%),radial-gradient(circle at 28% 66%,rgba(159,180,216,.5) 0 7%,transparent 10.5%),radial-gradient(circle at 88% 70%,rgba(169,191,160,.55) 0 6.5%,transparent 10%),radial-gradient(circle at 52% 82%,rgba(179,163,204,.5) 0 6%,transparent 9.5%),radial-gradient(circle at 14% 86%,rgba(196,141,151,.45) 0 5.5%,transparent 8.5%),radial-gradient(circle at 72% 90%,rgba(221,203,154,.5) 0 6%,transparent 9.5%)'), L(`position:absolute;top:5cqh;left:8cqw;font:540 44cqh var(--font-display);line-height:1;color:${IMPRESSION_SUIT[k]};text-shadow:0 0 1cqmin ${IMPRESSION_HALO[k]}`, R), L(`position:absolute;bottom:5cqh;right:8cqw;font-size:32cqh;line-height:1;color:${IMPRESSION_SUIT[k]};text-shadow:0 0 1cqmin ${IMPRESSION_HALO[k]}`, G)] }),
