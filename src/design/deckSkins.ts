...
const oldTimey = (mobile: boolean): Builder => ({ C, G, R }) => {
  ...
  const frame = [
    L('position:absolute;inset:2.5cqmin;border:0.75cqmin solid color-mix(in srgb,var(--warn) 72%,var(--card-black));border-radius:2.5cqmin', ''),
    L('position:absolute;inset:3.95cqmin;border:0.75cqmin solid color-mix(in srgb,var(--warn) 72%,var(--card-black));border-radius:1.5cqmin', ''),
...
const DESKTOP: Record<string, Builder> = {
  ...
  D41c: ({ G, R }) => ({ extra: 'border:1px solid var(--hairline)', layers: [L('position:absolute;inset:3cqmin;border:0.85cqmin solid var(--warn);border-radius:3cqmin;opacity:.7', ''), L('position:absolute;inset:4.65cqmin;border:0.85cqmin solid var(--warn);border-radius:1.6cqmin;opacity:.7', ''), L(rSerif, R), L(pipBR, G), L(wm(0.08), G)] }),
  ...
  C2: ({ C, G, R }) => ({ extra: 'border:1px solid var(--hairline);background:color-mix(in srgb,#efe7d2 80%,var(--card-face))', layers: [L('position:absolute;inset:5cqmin;border:1.5cqmin solid #2f7d4f;border-radius:3cqmin;opacity:.6', ''), L('position:absolute;inset:0;display:flex;align-items:center;justify-content:center;font:680 46cqh var(--font-display);color:#1e5a3a', R), L(`position:absolute;bottom:7cqh;left:0;right:0;text-align:center;font-size:16cqh;color:${C}`, G)] }),
...
const MOBILE: Record<string, Builder> = {
  ...
  C2: ({ C, G, R }) => ({ extra: 'border:1px solid var(--hairline);background:color-mix(in srgb,#efe7d2 80%,var(--card-face))', layers: [L('position:absolute;inset:5cqmin;border:1.5cqmin solid #2f7d4f;border-radius:3cqmin;opacity:.6', ''), L('position:absolute;top:15cqh;left:0;right:0;text-align:center;font:680 46cqh var(--font-display);line-height:1;color:#1e5a3a', R), L(`position:absolute;bottom:13cqh;left:0;right:0;text-align:center;font-size:28cqh;line-height:1;color:${C}`, G)] }),
...
const JOKER_DECOR: Record<string, (mobile: boolean) => Layer[]> = {
  ...
  D42: () => [
    L('position:absolute;right:5cqw;bottom:5cqh;width:54cqmin;height:54cqmin;display:flex;align-items:center;justify-content:center;font-size:26cqh;line-height:1;color:var(--joker)', '★'),
    L('position:absolute;top:6cqh;left:8cqw;font:700 13cqh var(--font-body);letter-spacing:.14em;color:var(--joker)', 'JOKER'),
  ],
  D42a: () => [
    L('position:absolute;right:4cqw;bottom:4cqh;width:58cqmin;height:58cqmin;display:flex;align-items:center;justify-content:center;font-size:22cqh;line-height:1;color:var(--joker)', '★'),
    L('position:absolute;top:6cqh;left:8cqw;font:700 13cqh var(--font-body);letter-spacing:.14em;color:var(--joker)', 'JOKER'),
  ],
  ...
  AR3: () => [
    ...
    // pip uses.
    L('position:absolute;right:-12cqw;top:-12cqh;width:48cqmin;height:48cqmin;display:flex;align-items:center;justify-content:center;font-size:22cqh;line-height:1;color:#fdf6ec', '★'),
