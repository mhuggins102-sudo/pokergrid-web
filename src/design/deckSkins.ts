...
const oldTimey = (mobile: boolean): Builder => ({ C, G, R }) => {
  ...
  const frame = [
    L('position:absolute;inset:2.5cqmin;border:0.75cqmin solid color-mix(in srgb,var(--warn) 72%,var(--card-black));border-radius:max(0px,calc(var(--radius-sm,8px) - 2.5cqmin))', ''),
    L('position:absolute;inset:3.95cqmin;border:0.75cqmin solid color-mix(in srgb,var(--warn) 72%,var(--card-black));border-radius:max(0px,calc(var(--radius-sm,8px) - 3.95cqmin))', ''),
    L('position:absolute;inset:6.5cqmin;border:1cqmin solid color-mix(in srgb,var(--warn) 72%,var(--card-black));border-radius:max(0px,calc(var(--radius-sm,8px) - 6.5cqmin));opacity:.5', ''),
  ];
  const center = fig
...
const DESKTOP: Record<string, Builder> = {
  ...
  D21: ({ C, G, R }) => ({ extra: 'border:1px solid var(--hairline)', layers: [L(`position:absolute;inset:3cqmin;border-radius:max(0px,calc(var(--radius-sm,8px) - 3cqmin));border:2.5cqmin solid ${C};opacity:.4`, ''), L(rSans, R), L(pipBR, G)] }),
  ...
  D41c: ({ G, R }) => ({ extra: 'border:1px solid var(--hairline)', layers: [L('position:absolute;inset:3cqmin;border:0.85cqmin solid var(--warn);border-radius:max(0px,calc(var(--radius-sm,8px) - 3cqmin));opacity:.7', ''), L('position:absolute;inset:4.65cqmin;border:0.85cqmin solid var(--warn);border-radius:max(0px,calc(var(--radius-sm,8px) - 4.65cqmin));opacity:.7', ''), L(rSerif, R), L(pipBR, G), L(wm(0.08), G)] }),
  ...
  D55b: ({ G, R }) => ({ extra: 'border:1px solid var(--hairline)', layers: [L('position:absolute;inset:3cqmin;border-radius:max(0px,calc(var(--radius-sm,8px) - 3cqmin));border:3cqmin dashed var(--warn);opacity:.7', ''), L('position:absolute;top:2cqmin;left:2cqmin;width:5cqmin;height:5cqmin;border-radius:50%;background:var(--warn)', ''), L('position:absolute;bottom:2cqmin;right:2cqmin;width:5cqmin;height:5cqmin;border-radius:50%;background:var(--warn)', ''), L(rSerif, R), L(pipBR, G)] }),
  ...
  C2: ({ C, G, R }) => ({ extra: 'border:1px solid var(--hairline);background:color-mix(in srgb,#efe7d2 80%,var(--card-face))', layers: [L('position:absolute;inset:5cqmin;border:1.5cqmin solid #2f7d4f;border-radius:max(0px,calc(var(--radius-sm,8px) - 5cqmin));opacity:.6', ''), L('position:absolute;inset:0;text-align:center;font:680 46cqh var(--font-display);line-height:100cqh;color:#1e5a3a', R), L(`position:absolute;bottom:7cqh;left:0;right:0;text-align:center;font-size:16cqh;color:${C}`, G)] }),
